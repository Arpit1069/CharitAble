...
class OrderdetailsNGO_food : BaseActivity() {

    private lateinit var database: FirebaseDatabase
    private lateinit var reference: DatabaseReference
    private lateinit var dbref : DatabaseReference
    private lateinit var userRecyclerView: RecyclerView
    private lateinit var userArrayList: ArrayList<OrderItems_food>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_orderdetails_food)

        userRecyclerView = findViewById(R.id.orderdetails_NGO_food)
        userRecyclerView.layoutManager = LinearLayoutManager(this)
        userRecyclerView.setHasFixedSize(true)

        userArrayList = arrayListOf<OrderItems_food>()
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    for(userSnapshot in snapshot.children) {
                        ...
                        val user = userSnapshot.getValue(OrderItems_food::class.java)
                        if (user != null) {
                    ...
                    val adapter = MyAdapter_food(userArrayList)

                    val swipegesture = object : SwipeGesture(this@OrderdetailsNGO_food){
...
//                                }
                    ...
                    userRecyclerView.adapter = MyAdapter_food(userArrayList)
